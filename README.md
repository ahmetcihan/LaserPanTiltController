This project is a C++ and Qt application for controlling a laser board mounted on a pan-tilt system. It allows you to adjust the laser's angle and speed precisely.
